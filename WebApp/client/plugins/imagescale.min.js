...
(function (l) {
    "function" === typeof define && define.amd ? define(["jquery"], l) : "object" === typeof module && module.exports ? module.exports = function (m, a) {
    ...
    m.prototype = {
        ...
        scale: function (a, f) {
            if (!this._isDestroyed && !1 !== this._canScale) {
                var d = this,
                    ...
                    k = this.$element,
                    h = this.$img;
                if (a) b.hideParentOverflow && g.css({
                    overflow: "hidden"
                });
                ...
                if (!b.rescaleOnResize || f || this._needUpdate(this.parent)) {
                    ...
                    if (n) {
                        ...
                        var p = this.imgWidth,
                            q = this.imgHeight;
                        h && c && p && q ? (this._cacheDestWidth = h, this._cacheDestHeight = c, e = this._innerFrameForSize(n, r, p, q, h, c), g && (e.x -= g / 2), l && (e.y -= l / 2), k.css({
                            position: "absolute",
                            top: e.y + "px",
                            left: e.x + "px",
                            width: e.width + "px",
                            ...
                            display: "none"
                        }), k.fadeIn(m)), b.didScale.call(this,
        ...
        _innerFrameForSize: function (a, f, d, b, g, e) {
            ...
            case this.BEST_FIT_DOWN_ONLY:
                a !==
                    this.BEST_FIT_DOWN_ONLY && 1 < this.options.logLevel && console.warn("imageScale - DEBUG WARNING: The scale '" + a + "' was not understood.");
                a = d > g || b > e ? k < h ? k : h : 1;
                break;
            case this.BEST_FIT:
                a = k < h ? k : h;
            ...
            case this.ALIGN_BOTTOM_RIGHT:
                ...
                break;
            default:
                f !== this.ALIGN_CENTER && 1 < this.options.logLevel && console.warn("imageScale - DEBUG WARNING: The align '" + f + "' was not understood."), c.x = g / 2 - d / 2, c.y = e / 2 - b / 2
            }
            return c
        },
