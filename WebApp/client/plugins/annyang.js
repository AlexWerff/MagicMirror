    ...
    root.annyang = {
        ...
        init: function (commands, resetCommands) {
            ...
            recognition.onresult = function (event) {
                ...
                if (root.annyang !== undefined && root.annyang.onSpeechRecognized !== undefined) {
                    root.annyang.onSpeechRecognized(results[0]);
                }
                ...
                for (var i = 0; i < results.length; i++) {
                    ...
                    for (var j = 0, l = commandsList.length; j < l; j++) {
                        ...
                        if (result) {
                            ...
                            var indexOfA = currentCommand.originalPhrase.indexOf("*a ");
                            if (indexOfA >= 0) {
                                parameters.splice(0, 1);
                            }
                            var indexOfB = currentCommand.originalPhrase.indexOf("*b ");
                            if (indexOfB >= 0) {
                            ...
                            if (root.annyang !== undefined && root.annyang.onCommandRecognized !== undefined) {
                                root.annyang.onCommandRecognized(currentCommand.originalPhrase);
                            }
